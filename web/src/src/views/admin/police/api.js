...
export function registerCriminalRecord(recordID, firstName, lastName, dateOfBirth, nationality, offences, offenseDate, region, city, subcity, acquittals) {
...
export function getCriminalRecord(recordID) {
  return fetch(`/law-enforcement/api/get-criminal-records`, {
    method: 'GET',
    headers: new Headers({
      'Content-Type': 'application/json'
    })
